...
public class JacksonObject extends Jackson {
    ...
    public byte[] getBytes(String key) {
        ...
        if (value.isBinary()) {
            ...
            try {
                ...
                throw new RuntimeException("[Jackson]getBytes时发生异常，msg:" + e.getMessage());
            }
            return bytes;
        } else {
            return null;
    ...
    /**
     * 通过 key 获取 Integer，会经过类型转换，不存在返回 0
     *
     * @param key key
     * @return int
     */
    public Integer getInteger(String key) {
        ...
        return OBJECT_MAPPER.convertValue(value, Integer.class);
    }
    ...
    /**
     * 通过 key 获取 Date，会经过类型转换，不存在返回 null
     * <p>
    ...
    public Date getDateTime(String key) {
        ...
        return OBJECT_MAPPER.convertValue(value, Date.class);
    }
